...
public class Constants {
    ...
    public static final String PHANTOM_JS_CHROME_DATA_PATH = "ChromeData";
    ...
    public static final String APP_DATA_DEFAULT_DIRECTORY_FILE = System.getProperty("user.dir") + "/appData";
